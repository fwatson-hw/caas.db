CREATE TABLE [Stg].[StructuredContent_concept] (
    [datetime_dt]           NVARCHAR (50)  NULL,
    [codesicd10cmR1_ss]     NVARCHAR (MAX) NULL,
    [conceptbucket_txt]     NVARCHAR (MAX) NULL,
    [codesicd9cmR1_ss]      NVARCHAR (MAX) NULL,
    [codesnuccR1_ss]        NVARCHAR (MAX) NULL,
    ...
    [id]                    NVARCHAR (50)  NULL,
    [codessnomedctR1_ss]    NVARCHAR (MAX) NULL,
    [pubhub_version_s]      NVARCHAR (10)  NULL,
    [status_s]              NVARCHAR (10)  NULL,
